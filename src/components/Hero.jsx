...
const data = [
    {
        ...
        subhead: 'Your ultimate destination for seamless paper preparation. Whether you are drafting research papers, creating academic assignments, or organizing ideas, we have got you covered. Start crafting brilliance today!'
    }
]
  ...
  return (
    <HeroWrapper>
      <ContentWrapper>
        ...
        <EmailText variant="subtitle1">
        info@malikharoon.com
        </EmailText>
      </ContentWrapper>
    </HeroWrapper>
  );
